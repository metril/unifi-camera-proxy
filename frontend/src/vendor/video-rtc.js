 ...
 *
 * Vendored from https://github.com/AlexxIT/go2rtc (MIT License) to drive the
 * live-preview tiles. Plays WebRTC with automatic fallback to MSE/HLS/MJPEG,
 * which is what makes preview work through the /go2rtc/* reverse proxy even
 * when the WebRTC UDP port is not exposed.
 *
